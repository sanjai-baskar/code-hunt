            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-4">
              ...
              <div className="flex gap-2 w-full sm:w-auto">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 md:px-4 py-1.5 md:py-2 text-xs md:text-sm rounded-lg border border-green-500/30 bg-green-500/10 text-green-500 hover:bg-green-500/20 transition-colors font-medium"
                >
